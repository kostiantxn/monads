...
{
    public ListMonadAwaiter<T> GetAwaiter() =>
        new(this);
}

// TODO: Auto-generate.
public abstract class ListMonadAwaiter : INotifyCompletion
{
    private bool _set;
...
public class ListMonadAwaiter<T>(List<T> container) : ListMonadAwaiter
{
    ...
    public override List<TMap> Bind<TMap>(Func<object, List<TMap>> map) =>
...
public class ListMonadMethodBuilder<T>
{
    ...
    public void AwaitOnCompleted<TAwaiter, TStateMachine>(ref TAwaiter awaiter, ref TStateMachine stateMachine)
        where TAwaiter : ListMonadAwaiter, INotifyCompletion
        where TStateMachine : IAsyncStateMachine
    {
    ...
    public void AwaitUnsafeOnCompleted<TAwaiter, TStateMachine>(ref TAwaiter awaiter, ref TStateMachine stateMachine)
        where TAwaiter : ListMonadAwaiter, ICriticalNotifyCompletion
        where TStateMachine : IAsyncStateMachine =>
